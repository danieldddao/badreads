Feature: Registered user unfollows other users
...
Scenario: Unregistered user can't unfollow
  When I follow "Test Book1"
  Then I should not see "Unfollow" button

Scenario: Registered user can unfollow followed users
  ...
  And I follow "TestBook2"
  And I click "follow_1"
  When I follow "Test Book1"
  Then I should see "Unfollow" button
  
Scenario: Registered user unfollows followed users who have posted reviews
  Given I have user account with information: email "follower@gmail.com", first_name "testfirstname", last_name "testlastname", password "123456", password_confirmation "123456", position "User"
  And I log in to my account with information: email "follower@gmail.com", password "123456"
  And I follow "TestBook2"
  And I click "follow_1"
  When I follow "Test Book1"
  And I click "unfollow_1"
  Then I should see "Successfully unfollowed user: testfirstname testlastname" notice
  Then I should see "Follow" button