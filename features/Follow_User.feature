Feature: Registered user follows other users
...
Scenario: Unregistered user can't follow
  When I follow "Test Book1"
  Then I should not see "Follow" button

Scenario: Registered user can follow
...
Scenario: Registered user follows other users who have posted reviews
  Given I have user account with information: email "follower@gmail.com", first_name "testfirstname", last_name "testlastname", password "123456", password_confirmation "123456", position "User"
  And I log in to my account with information: email "follower@gmail.com", password "123456"
  And I follow "TestBook2"
  When I click "follow_1"
  Then I should see "Successfully followed user: testfirstname testlastname" notice