Feature: Registered user views list of users following him/her
...
Scenario: Unregistered user can't view followers
  When I am on the badreads home page
  Then I should not see "Followers" button

Scenario: Registered user can view followers
